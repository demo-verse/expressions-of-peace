  ...
  return (
    <div>
      ...
      <p>
        ...
        component of the dynamics of a World Peace, relating to quality
        (peacefulness) and quantity (verifications) of interactions.
        <br></br>
        <br></br>
        ...
        <i>
          <a
            href="https://www.cogsec.org/what-is-cognitive-security"
            target={"_blank"}
            rel="noreferrer"
          >
            {" "}
      ...
      {"  "}
      on test networks, in this context, act as transparent mail boxes, to
      become global consensus contracts. where we would sign, without requiring
      money with real value. <br></br>
